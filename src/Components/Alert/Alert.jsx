...
const Alert = () => {
  ...
  const event = useSelector((state) => state.MedicalStorage.events);
  const overlayRef = useRef(null);
  const isPending = useSelector(
    (state) => state.MedicalStorage.transaction.isPending
  );
  const isError = useSelector(
    (state) => state.MedicalStorage.transaction.isError
  );
